...
impl UploadWatcherComponent {
    ...
    pub async fn upload_watch(&self) -> Result<ListOfUploadWatchInfoHarbor, &ErrorSet> {
        ...
        for loading in loading_reply.list_of_upload_info {
            let harbor_data = UploadWatchInfoHarbor {
                ...
                percent_of_completion: (loading.encrypted_count as u32 * 100
                    / loading.total_part as u32) as u32,
            };
