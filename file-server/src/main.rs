...
mod test {
    ...
    // use common-config::conf_reader::read_config;
    // use common-config::properties::{get_prop_pg_connect_string, get_prop_value, set_prop_values};
    // //use crate::{insert_document_part, parse_content, select_tsvector};
    // use log::{error,info};
    // use commons_error::*;
    // use common-config::property_name::LOG_CONFIG_FILE_PROPERTY;
    //
    // fn init_test() {
